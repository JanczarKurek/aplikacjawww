...
urlpatterns = [
    ...
    path('accounts/inactive', views.inactive_user_view, name='inactive_user'),
    path('accounts/login/', views.LoginViewWithActivation.as_view(template_name='login.html'), name='login'),
